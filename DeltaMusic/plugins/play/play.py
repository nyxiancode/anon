...
from DeltaMusic.utils.database import is_video_allowed
...
from DeltaMusic.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
...
from DeltaMusic.utils.database import is_served_user
...
@app.on_callback_query(filters.regex("DeltaPlaylists") & ~BANNED_USERS)
@languageCB
